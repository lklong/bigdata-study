...
> **团队架构**: [大数据运维专家团队架构 v1.1](./01-大数据运维专家团队架构.md) — 7 大专家组 + 全组件专家级能力对齐 (2/15→15/15)
> **源码方法论**: [源码精通方法论 v2.0](./spark/源码/学习方法论.md) — 九大法则 + 四段位 + 90天路线图
> **排障方法论**: [问题分析方法论 v1.0](./00-问题分析方法论.md) — 黄金六步法 + 五大根因分析工具 + MECE 决策树
...
### 团队架构
- [大数据运维专家团队架构](./01-大数据运维专家团队架构.md) — 7 大专家组 · 5 维度专家级标准 · 全组件能力评估矩阵 · 3 Wave 能力对齐计划
