...
| 06 | [LDAP 数据治理与灾备演练专题](./06-LDAP数据治理与灾备演练专题.md) | 数据"防/救/管/演"全闭环，3-2-1备份、accesslog穿越、演练 SOP | 数据负责人 / DBA |
...
| 想做季度灾备演练 | 05-§13 演练矩阵 |
| 故障复盘怎么写 | 05-§14 复盘模板 |
| **数据丢了怎么找回** | **06-§2 救：accesslog 穿越/备份/PITR/HRIS 兜底** |
| **数据怎么管理** | **06-§3 管：质量+血缘+权限+生命周期+合规** |
| **怎么做故障演练** | **06-§4 演：DD-01~DD-10 完整矩阵+SOP** |
| **3-2-1 备份原则怎么落地** | **06-§1.7** |
