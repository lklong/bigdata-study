...
| **L8 错误码字典** | [08-Kerberos错误码全字典.md](./08-Kerberos错误码全字典.md) | 速查 | 100+ 错误码 → 根因 → 一句话解法 |
| **L9 5分钟定位** | [09-Kerberos5分钟根因定位手册.md](./09-Kerberos5分钟根因定位手册.md) | 速查 | 现象→症状→根因→修复 速查矩阵 |
| **L10 日志分析** | [10-Kerberos日志分析速查表.md](./10-Kerberos日志分析速查表.md) | 速查 | grep/awk/正则模板 + 一行命令 |
| **L11 根因树状图** | [11-Kerberos根因树状速查图.md](./11-Kerberos根因树状速查图.md) | 速查 | 8 大子树 + One-Pager 速查 |
| **🔧 工具箱** | [工具箱/](./工具箱/) | 实战 | kerb-doctor / kvno-fixer / 错误分类器 等 8 个脚本 |
...
| 2026-05-10 | **实战工具化** | 新增 08 错误码字典 + 09 5分钟定位 + 10 日志速查 + 11 根因树 + 工具箱（8 个生产级脚本） |
