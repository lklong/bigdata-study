...
```scala
// from core/src/main/scala/org/apache/spark/ExecutorAllocationManager.scala L206-218
...
```scala
// from core/src/main/scala/org/apache/spark/scheduler/dynalloc/ExecutorMonitor.scala L52-55
...
```scala
// from sql/core/src/main/scala/org/apache/spark/sql/execution/exchange/ShuffleExchangeExec.scala L166-179
  @transient
...
```scala
// from core/src/main/scala/org/apache/spark/Dependency.scala L96-99
...
```scala
// from core/src/main/scala/org/apache/spark/Dependency.scala L177-178
...
```java
// from common/network-shuffle/src/main/java/org/apache/spark/network/shuffle/ExternalShuffleBlockResolver.java L143-159
...
```java
// from common/network-shuffle/src/main/java/org/apache/spark/network/shuffle/ExternalShuffleBlockResolver.java L305-323
...
```scala
// from core/src/main/scala/org/apache/spark/ExecutorAllocationManager.scala L340-351
...
```scala
// from core/src/main/scala/org/apache/spark/scheduler/dynalloc/ExecutorMonitor.scala L118-133
...
```scala
// from core/src/main/scala/org/apache/spark/scheduler/dynalloc/ExecutorMonitor.scala L329-333
...
```scala
// from core/src/main/scala/org/apache/spark/scheduler/dynalloc/ExecutorMonitor.scala L557-570
...
```scala
// from core/src/main/scala/org/apache/spark/ExecutorAllocationManager.scala L556-567
...
```scala
// from core/src/main/scala/org/apache/spark/ContextCleaner.scala L131-132
...
```java
// from common/network-shuffle/src/main/java/org/apache/spark/network/shuffle/ExternalShuffleBlockResolver.java L245-260
...
```java
// from common/network-shuffle/src/main/java/org/apache/spark/network/shuffle/ExternalShuffleBlockResolver.java L281-286
...
```java
// from common/network-yarn/src/main/java/org/apache/spark/network/yarn/YarnShuffleService.java L354-373
  @Override
...
```java
// from common/network-yarn/src/main/java/org/apache/spark/network/yarn/YarnShuffleService.java L381-385
  @Override
...
```scala
// from core/src/main/scala/org/apache/spark/internal/config/package.scala L611-616
...
```scala
// from core/src/main/scala/org/apache/spark/internal/config/package.scala L603-609
...
```scala
// from core/src/main/scala/org/apache/spark/internal/config/package.scala L618-622
...
```scala
// from core/src/main/scala/org/apache/spark/internal/config/package.scala L624-629
...
```scala
// from core/src/main/scala/org/apache/spark/internal/config/package.scala L656-660
...
```scala
// from core/src/main/scala/org/apache/spark/internal/config/package.scala L662-670
...
```scala
// from core/src/main/scala/org/apache/spark/internal/config/package.scala L672-678
...
```scala
// from core/src/main/scala/org/apache/spark/internal/config/package.scala L680-681
...
```scala
// from core/src/main/scala/org/apache/spark/internal/config/package.scala L683-691
...
```scala
// from core/src/main/scala/org/apache/spark/internal/config/package.scala L430-436
...
```scala
// from core/src/main/scala/org/apache/spark/internal/config/package.scala L1641-1645
...
```scala
// from core/src/main/scala/org/apache/spark/internal/config/package.scala L1659-1663
