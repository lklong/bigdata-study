-- ====================================================================
-- 80GB Bench 数据集 5 张外部表 DDL — cosn 版（库 = bench_cosn）
-- 来源：bench-toolkit/ddl/external_tables.sql
-- 改动：库名 bench → bench_cosn；LOCATION 保持 cosn://lkl-bj-update-1308597516/meson/data/bench/<table>
-- 数据：5 表 / 29 亿行 / 91.7G Parquet
-- 适用：Hive 2.3.7（H2）/ Hive 3.1.3（H3）双版本
-- ====================================================================
